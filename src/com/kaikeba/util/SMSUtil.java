...
public class SMSUtil {
    ...
    public static boolean send(String phoneNumber,String code) {
        //sms信息accessKeyId和secret需自己填写，可申请阿里云免费短信100条
        ...
        request.putQueryParameter("TemplateCode", "SMS_205457433");
    ...
    public static boolean loginSMS(String phoneNumber,String code) {
        ...
        request.putQueryParameter("RegionId", "cn-hangzhou");
        request.putQueryParameter("PhoneNumbers", phoneNumber);
        //阿里云签名管理的签名名称SignName和模板管理的模板名称TemplateCode需自己填写
        request.putQueryParameter("SignName", "快件E栈");
        request.putQueryParameter("TemplateCode", "SMS_205615266");
        request.putQueryParameter("TemplateParam", "{\"code\":\""+code+"\"}");
        try {
            CommonResponse response = client.getCommonResponse(request);
            System.out.println(response.getData());
